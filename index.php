...
<head>
    <meta charset="UTF-8">
    <title>BooksApp || Buku merubah hidupMu!</title>
    ...
    <meta name="BooksApp" content="BooksApp" />
    <!-- bootstrap 3.0.2 -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <b>Selamat Datang di BooksApp, Untuk Login silahkan klik Icon User atau klik <a href="login.html">disini</a></b>
                        </div>
                    </div>
            ...
            <div class="col-md-12">
                <section class="panel">
                    ...
                    <div class="panel-body table-responsive">
                        ...
                        <hr />
                        <?php $tampil1 = pgsql_query($conn, "select * from admin order by id_admin");
                        $user1 = pgsql_num_rows($tampil1);
                        ?>
                        <center>
                            <h4>Jumlah Total Admin : <?php echo "$user1"; ?> Orang </h4>
                        </center>
                    </div>
                </section>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">BooksApp</h4>
                </div>
                <div class="modal-body">
                    <p> BooksApp adalah salah satu layanan bagi pengguna untuk dapat mengakses berbagai buku bacaan yang dan dilakukan kapan saja dan dari mana saja, dengan menggunakan jaringan internet.</p>
                    <p> BooksApp memiliki koleksi buku dalam bentuk format digital dan bisa diakses dengan komputer. koleksi bacaan dari BooksApp dapat diakses dengan cepat dan mudah lewat jaringan komputer.</p>
                    <p> BooksApp bebasis website yang responsif, untuk info, saran, maupun kritik bisa menghubungi kami :</p>
                    <table>
                        <tr>
                            <td>E-mail</td>
                            <td>:</td>
                            <td><a href="sisteminformasi494@gmail.com">BooksApp@gmail.com</a></td>
                        </tr>
                        <br />
                        <tr>
                            <td>Blog</td>
                            <td>:</td>
                            <td><a href="#" target="_blank">www.BooksApp.com</a></td>
                        </tr>
                        <br />
                        <tr>
                            <td>Website</td>
